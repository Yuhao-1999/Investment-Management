...
public class Investment {
    ...
    public Investment(String title, String description, String budget, String periodOfReturn, String investmentID, String price, String category, String company, boolean isActive, boolean isRecommended) {
        this.title = title;
